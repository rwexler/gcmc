...
from new_io import qe_out_info, make_qe_in
from new_io import init_log, upd_log
from new_io import init_axsf, upd_axsf
from new_mc import mc
from new_bv import bv
import os
import numpy as np
...
#	forces = qe_out.get_forces() * ry_ev / bohr_ang # convert forces from ry/bohr to ev/ang
	...
	upd_axsf(axsf_file, i, xsf, el, forces)
